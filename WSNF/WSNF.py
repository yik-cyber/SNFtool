import pyreadr
from SNF.SNF import *
from spectral_clustering.spectralClustering import *
import pandas as pd
import numpy as np
...
def MAD(mat):
    ...
    for i in range(median.shape[0] - 1):
...
def WSNF(datasets, feature_rankings, beta, clusterNum, K, alpha, t):
    ...
    SpectualClustering(W, clusterNum)